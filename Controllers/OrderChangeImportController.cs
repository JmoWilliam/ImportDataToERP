...
[Authorize]
public class OrderChangeImportController : Controller
{
    private readonly OrderChangeImportService _service;

    public OrderChangeImportController(OrderChangeImportService service)
    {
        _service = service;
    }
    ...
    {
        return View("Edit", new OrderChangeHeader());
    }

    [HttpPost]
    public async Task<IActionResult> Create(OrderChangeHeader header)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Edit(int id, OrderChangeHeader header)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateDetail([FromBody] OrderChangeDetail detail)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> UpdateDetail([FromBody] OrderChangeDetail detail)
    {
        if (detail.Id <= 0)
    ...
    public async Task<IActionResult> Confirm()
    {
        ...
        var groups = JsonSerializer.Deserialize<List<OrderChangeHeaderGroup>>(json);
